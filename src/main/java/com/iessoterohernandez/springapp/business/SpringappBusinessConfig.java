package com.iessoterohernandez.springapp.business;
...
@EnableJpaRepositories("com.iessoterohernandez.springapp.business.repositories")
public class SpringappBusinessConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		hibernateJpa.setGenerateDdl(env.getProperty("hibernate.generateDb1",Boolean.class));
	...
	@Bean
	public JpaTransactionManager transctionManager() {
